/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5c97bdd77c64d572e3c7e4942fadd955)
// Runtime types generated with workerd@1.20260811.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MAX_ACCOUNTS: "25";
	ADMIN_TOOLS: "0";
	MCP_OBJECT: DurableObjectNamespace /* WallosMCP */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_ACCOUNTS" | "ADMIN_TOOLS">> {}
}
declare module "*.html" {
	const value: string;
